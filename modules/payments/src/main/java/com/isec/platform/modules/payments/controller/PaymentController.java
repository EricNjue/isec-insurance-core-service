...
public class PaymentController {
    ...
    public Mono<Payment> initiateStkPush(
        ...
        return paymentService.initiateSTKPush(
    ...
    public Mono<Map<String, String>> mpesaCallback(@RequestBody MpesaCallbackRequest request) {
        ...
        return paymentService.handleCallback(request)
                .thenReturn(Map.of("ResultCode", "0", "ResultDesc", "Success"));
    }
}
